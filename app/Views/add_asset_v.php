...
<div class="row pt-3">
    <div class="col-lg-8 mx-auto">
        <div class="hero-card shadow-lg mb-4 text-center" style="padding: 1.5rem !important;">
            <h4 class="mb-0 fs-6 fw-bold">Register Aplikasi Baru</h4>
        </div>
            ...
            <div class="card-body p-4">
                ...
                <form action="<?= base_url('dashboard/save') ?>" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="deskripsi" class="form-control" rows="3" placeholder="Jelaskan fungsi atau detail aplikasi secara singkat..."></textarea>
                    </div>
