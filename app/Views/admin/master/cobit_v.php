    ...
    <div class="col-12" data-aos="fade-down">
        <div class="card border-0 rounded-4 overflow-hidden position-relative shadow-sm bg-white">
            <div class="card-body p-4 position-relative z-1 d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3 border-start border-4 border-primary">
                <div>
                    <span class="badge bg-primary bg-opacity-10 text-primary mb-2 fs-2 fw-medium px-3 py-1 rounded-pill"><i class="ti ti-shield-check me-1"></i> SIMPA Master Data</span>
                    <h4 class="fw-bold text-dark mb-1">Master Instrumen COBIT-19</h4>
                    <p class="mb-0 text-muted" style="max-width: 600px;">Instrumen asesmen audit untuk pemenuhan standar tata kelola IT perusahaan.</p>
                </div>
                <?php if (session()->get('role') == 'Admin') : ?>
                <div>
                    <button type="button" class="btn btn-primary fw-bold d-inline-flex align-items-center shadow-sm px-4 py-2 rounded-3" data-bs-toggle="modal" data-bs-target="#modalCobit">
