    ...
    <div class="col-12">
        <div class="card border-0 rounded-4 overflow-hidden position-relative shadow-sm bg-white">
            <div class="card-body p-4 position-relative z-1 d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3 border-start border-4 border-primary">
                <div>
                    <span class="badge bg-primary bg-opacity-10 text-primary mb-2 fs-2 fw-medium px-3 py-1 rounded-pill"><i class="ti ti-folder me-1"></i> SIMPA Vault</span>
                    <h4 class="fw-bold text-dark mb-1">Pusat Dokumen Proyek</h4>
                    <p class="mb-0 text-muted" style="max-width: 600px;">Cari dan unduh seluruh berkas pendukung progress aplikasi (Laporan, Bukti Implementasi, dll) secara terpusat.</p>
                </div>
            </div>
        </div>
    </div>
